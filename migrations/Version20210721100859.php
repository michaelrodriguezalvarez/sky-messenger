 ...
 */
final class Version20210721100859 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE actividad (id INT AUTO_INCREMENT NOT NULL, usuario INT DEFAULT NULL, estado VARCHAR(255) NOT NULL, INDEX fk_usuario_actividad (usuario), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
